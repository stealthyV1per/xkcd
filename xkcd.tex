...
\begin{document}
  ...
  {tar.png}
  {
    I don't know what's worse-- the fact that after 15 years of using tar I still can't keep the flags straight,
    or that after 15 years of technological advancement I'm still mucking with tar flags that were 15 years old when I started.
  }
  {https://xkcd.com/1168/}
  ...
  {alien_visitors.png}
  {
    Stay right there, we'll be back in a minute.
    We've just gotta brainstorm some new wonders.
    Have you all figured out gears yet?
    Yes?
    Crap.
  }
  {https://xkcd.com/2477/}
  ...
  {
    ``Although fresh juice DOES sound--''
  ...
  {houseguests.png}
  {
    You can come on in, we're all fully vaccinated.
    Except the spare room off the living room.
    Don't go in there, we're not fully vaccinated in there.
  }
  {https://xkcd.com/2479/}
  ...
  {
    Several of the guests are secretly playing Meta Board Game Party.
    Every minute of parallel debate in the breakaway faction earns double victory points!
  }
  {https://xkcd.com/2486/}
\end{document}